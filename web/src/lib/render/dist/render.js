...
//#endregion
//#region src/lib/model/canvas.ts
function newId() {
...
function CanvasSheet($$renderer, $$props) {
	...
	$$renderer.component(($$renderer) => {
		...
		*/
		let { doc, field, removeItem, addItem, addMessage, grip, pickValue, addTrait } = $$props;
		...
		*/
		...
		function text($$renderer, slot) {
			if (field) {
				...
				$$renderer.push("<!--[-1-->");
				$$renderer.push(`${escape_html(slot.value)}`);
			}
			$$renderer.push(`<!--]-->`);
		}
		function communication($$renderer, label, lanes, area, question) {
			$$renderer.push(`<section${attr_class(`panel panel--collab ${stringify(area)}`, "svelte-18zyimi")}><h2 class="panel__label svelte-18zyimi">${escape_html(label)}</h2> <div class="panel__body svelte-18zyimi">`);
			if (lanes.length > 0) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<ul class="lanes svelte-18zyimi"><!--[-->`);
				...
				for (let laneIndex = 0, $$length = each_array.length; laneIndex < $$length; laneIndex++) {
					...
					$$renderer.push(`<li class="lane svelte-18zyimi"><div class="lane__head svelte-18zyimi">`);
					if (grip) {
						$$renderer.push("<!--[0-->");
						grip($$renderer);
						$$renderer.push(`<!---->`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--> <h3 class="lane__who svelte-18zyimi">`);
					if (pickValue) {
						$$renderer.push("<!--[0-->");
						pickValue($$renderer, {
						...
						$$renderer.push("<!--[1-->");
						$$renderer.push(`<span class="kind svelte-18zyimi" aria-hidden="true">`);
						kindIcon($$renderer, lane.collaborator.kind, "lane");
						$$renderer.push(`<!----></span><span class="sr-only svelte-18zyimi">${escape_html(`${KIND_META[lane.collaborator.kind].label}: `)}</span>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--> `);
					text($$renderer, {
					...
					if (pickValue) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<p${attr_class("rel svelte-18zyimi", void 0, { "rel--unset": lane.relationship === void 0 })}><span class="rel__theirs svelte-18zyimi">`);
						pickValue($$renderer, {
							kind: "relationship",
							key: `${lane.id}:theirs`,
						...
						$$renderer.push(`<!----></span><span class="rel__arrow svelte-18zyimi" aria-hidden="true">→</span><span class="rel__ours svelte-18zyimi">`);
						pickValue($$renderer, {
							kind: "relationship",
							key: `${lane.id}:ours`,
						...
						$$renderer.push("<!--[1-->");
						$$renderer.push(`<p class="rel svelte-18zyimi">`);
						if (lane.relationship.theirs !== void 0) {
							$$renderer.push("<!--[0-->");
							$$renderer.push(`<span class="sr-only svelte-18zyimi">Collaborator: </span><span class="rel__theirs svelte-18zyimi">${escape_html(lane.relationship.theirs)}</span>`);
						} else $$renderer.push("<!--[-1-->");
						$$renderer.push(`<!--]--><span class="rel__arrow svelte-18zyimi" aria-hidden="true">→</span>`);
						if (lane.relationship.ours !== void 0) {
							$$renderer.push("<!--[0-->");
							$$renderer.push(`<span class="sr-only svelte-18zyimi">this context: </span><span class="rel__ours svelte-18zyimi">${escape_html(lane.relationship.ours)}</span>`);
						} else $$renderer.push("<!--[-1-->");
						$$renderer.push(`<!--]--></p>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--> `);
					if (lane.messages.length > 0) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<ul class="msgs svelte-18zyimi"><!--[-->`);
						...
						for (let messageIndex = 0, $$length = each_array_1.length; messageIndex < $$length; messageIndex++) {
							...
							$$renderer.push(`<li class="msg svelte-18zyimi"${attr("data-meaning", message.type)}><span class="msg__glyph svelte-18zyimi" aria-hidden="true">${escape_html(GLYPHS[message.type])}</span><span class="sr-only svelte-18zyimi">${escape_html(message.type)},</span>`);
							text($$renderer, {
								value: message.name,
								label: "Message name",
							...
							$$renderer.push(`<!----> `);
							if (field || message.description) {
								$$renderer.push("<!--[0-->");
								$$renderer.push(`<span class="msg__desc svelte-18zyimi">`);
								text($$renderer, {
		...
		function languageSection($$renderer) {
			$$renderer.push(`<section class="panel panel--lang svelte-18zyimi"><h2 class="panel__label svelte-18zyimi">Ubiquitous language</h2> <div class="panel__body svelte-18zyimi">`);
			if (doc.ubiquitousLanguage.length > 0) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<dl class="terms svelte-18zyimi"><!--[-->`);
				const each_array_2 = ensure_array_like(doc.ubiquitousLanguage);
				for (let index = 0, $$length = each_array_2.length; index < $$length; index++) {
					let entry = each_array_2[index];
					$$renderer.push(`<div class="terms__row svelte-18zyimi"><dt class="svelte-18zyimi">`);
					text($$renderer, {
						value: entry.term,
						label: "Term",
						placeholder: "Term",
					...
					if (field || entry.definition) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<dd class="svelte-18zyimi">`);
						text($$renderer, {
		...
		function decisionsSection($$renderer) {
			$$renderer.push(`<section class="panel panel--decisions svelte-18zyimi"><h2 class="panel__label svelte-18zyimi">Business decisions</h2> <div class="panel__body svelte-18zyimi">`);
			if (doc.businessDecisions.length > 0) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<ul class="stack stack--policy svelte-18zyimi"><!--[-->`);
				const each_array_3 = ensure_array_like(doc.businessDecisions);
				for (let index = 0, $$length = each_array_3.length; index < $$length; index++) {
					let decision = each_array_3[index];
					$$renderer.push(`<li class="svelte-18zyimi">`);
					stackMarker($$renderer, false);
					$$renderer.push(`<!----><b class="svelte-18zyimi">`);
					text($$renderer, {
						value: decision.name,
						label: "Decision",
						placeholder: "Rule",
					...
					$$renderer.push(`<!----></b> `);
					if (field || decision.description) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<span class="stack__detail svelte-18zyimi">`);
						text($$renderer, {
		...
		function stickies($$renderer, label, itemLabel, terse, question, items, area, hotspot) {
			$$renderer.push(`<section${attr_class(`panel ${stringify(area)}`, "svelte-18zyimi", { "panel--hotspot": hotspot })}><h2 class="panel__label svelte-18zyimi">${escape_html(label)}</h2> <div class="panel__body svelte-18zyimi">`);
			if (items.length > 0) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<ul${attr_class("stack svelte-18zyimi", void 0, { "stack--hotspot": hotspot })}><!--[-->`);
		...
		$$renderer.push(`<article class="quiet-sheet svelte-18zyimi"><header class="tb svelte-18zyimi"><div class="tb__id svelte-18zyimi"><p class="tb__eyebrow svelte-18zyimi">Bounded Context Canvas · V5</p> <h1 class="tb__name svelte-18zyimi">`);
		text($$renderer, {
			value: doc.name,
			label: "Name",
		...
		$$renderer.push(`<!----></h1></div></header> <div class="grid svelte-18zyimi"><section class="panel area-purpose svelte-18zyimi"><h2 class="panel__label svelte-18zyimi">Purpose</h2> <div class="panel__body svelte-18zyimi">`);
		if (field || doc.purpose) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<p class="prose svelte-18zyimi">`);
			text($$renderer, {
				value: doc.purpose,
				label: "Purpose",
		...
		$$renderer.push(`<!--]--></div></section> <section class="panel area-classification svelte-18zyimi"><h2 class="panel__label svelte-18zyimi">Strategic classification</h2> <div class="panel__body svelte-18zyimi"><dl class="axes svelte-18zyimi"><!--[-->`);
		const each_array_5 = ensure_array_like(axes());
		for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
			let axis = each_array_5[$$index_5];
			$$renderer.push(`<div class="svelte-18zyimi"><dt class="svelte-18zyimi">${escape_html(axis.label)}</dt> <dd class="svelte-18zyimi">`);
			if (pickValue) {
				$$renderer.push("<!--[0-->");
				pickValue($$renderer, {
					kind: axis.kind,
				...
				$$renderer.push("<!--[-1-->");
				$$renderer.push(`${escape_html(axis.value ?? "—")}`);
			}
			$$renderer.push(`<!--]--></dd></div>`);
		}
		$$renderer.push(`<!--]--></dl></div></section> <section class="panel area-roles svelte-18zyimi"><h2 class="panel__label svelte-18zyimi">Domain roles</h2> <div class="panel__body svelte-18zyimi">`);
		if (doc.domainRoles.length > 0) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<ul class="roles svelte-18zyimi"><!--[-->`);
			...
			for (let index = 0, $$length = each_array_6.length; index < $$length; index++) {
				...
				$$renderer.push(`<li${attr_class("role svelte-18zyimi", void 0, { "role--caution": CAUTION_TRAITS.has(role.name) })}>${escape_html(role.name)}`);
				if (CAUTION_TRAITS.has(role.name)) {
					$$renderer.push("<!--[0-->");
					$$renderer.push(`<span class="role__caution svelte-18zyimi" aria-hidden="true">⚠</span><span class="sr-only svelte-18zyimi">— likely anti-pattern</span>`);
				} else $$renderer.push("<!--[-1-->");
				$$renderer.push(`<!--]-->`);
				removeItem?.($$renderer, {
		...
		$$renderer.push(`<!----></div></section> `);
		communication($$renderer, "Inbound communication", doc.inboundCommunication, "area-inbound", "+ collaborator — who sends this context commands, queries or events?");
		$$renderer.push(`<!----> <div class="centre area-centre svelte-18zyimi">`);
		languageSection($$renderer);
		$$renderer.push(`<!----> `);
		decisionsSection($$renderer);
		$$renderer.push(`<!----></div> `);
		communication($$renderer, "Outbound communication", doc.outboundCommunication, "area-outbound", "+ collaborator — who consumes what this context emits?");
		$$renderer.push(`<!----> `);
		stickies($$renderer, "Assumptions", "Assumption", "+ assumption", "+ assumption — what are you taking to be true?", doc.assumptions, "area-assumptions", false);
		$$renderer.push(`<!----> `);
		stickies($$renderer, "Verification metrics", "Verification metric", "+ metric", "+ metric — what would verify this design?", doc.verificationMetrics, "area-metrics", false);
		$$renderer.push(`<!----> `);
		stickies($$renderer, "Open questions", "Open question", "+ question", "+ question — what's still unresolved?", doc.openQuestions, "area-questions", true);
		$$renderer.push(`<!----></div> <footer class="foot svelte-18zyimi"><ul class="key svelte-18zyimi" data-legend=""><!--[-->`);
		const each_array_7 = ensure_array_like(LEGEND);
		for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
			let entry = each_array_7[$$index_7];
			$$renderer.push(`<li class="svelte-18zyimi"><span class="key__swatch svelte-18zyimi"${attr("data-meaning", entry.meaning)} aria-hidden="true"></span>${escape_html(entry.label)}</li>`);
		}
		$$renderer.push(`<!--]--> <!--[-->`);
		const each_array_8 = ensure_array_like(Object.keys(KIND_META));
		for (let $$index_8 = 0, $$length = each_array_8.length; $$index_8 < $$length; $$index_8++) {
			let kind = each_array_8[$$index_8];
			$$renderer.push(`<li class="svelte-18zyimi"><span class="key__icon svelte-18zyimi">`);
			kindIcon($$renderer, kind, "key");
			$$renderer.push(`<!----></span>${escape_html(KIND_META[kind].label.toLowerCase())}</li>`);
		}
		$$renderer.push(`<!--]--> <li class="svelte-18zyimi"><span class="sr-only svelte-18zyimi">relationship: </span><span class="key__theirs svelte-18zyimi">theirs</span><span class="key__arrow svelte-18zyimi" aria-hidden="true">→</span><span class="key__ours svelte-18zyimi">ours</span></li></ul> <p class="note svelte-18zyimi">Based on the <a${attr("href", REPO_URL)} class="svelte-18zyimi">Bounded Context Canvas by the ddd-crew</a> · <a${attr("href", LICENSE_URL)} class="svelte-18zyimi">CC BY 4.0</a></p></footer></article>`);
	});
}
//#endregion
//#region src/lib/model/title.ts
...
//#endregion
//#region src/lib/render/metrics.ts
/**
...
//#endregion
//#region src/lib/render/module.ts
/**
...
function renderSheetParts(doc) {
	...
	return {
		...
		css: `.${SCOPE_CLASS} {\n/* Quiet-sheet tokens (SPEC §5). AA-verified by src/lib/sheet/contrast.test.ts;
