...
function stackMarker($$renderer, tilted) {
  $$renderer.push(`<svg xmlns="http://www.w3.org/2000/svg" class="stack__marker svelte-18zyimi" viewBox="0 0 7 7" aria-hidden="true"><rect x="0.5" y="0.5" width="6" height="6" rx="2"${attr("transform", tilted ? "rotate(14 3.5 3.5)" : void 0)} class="svelte-18zyimi"></rect></svg>`);
}
var GLYPHS = {
  command: "\u25B6",
  query: "?",
    ...
    function decisionsSection($$renderer3) {
      ...
      if (doc.businessDecisions.length > 0) {
        ...
        for (let index = 0, $$length = each_array_3.length; index < $$length; index++) {
          ...
          stackMarker($$renderer3, false);
          $$renderer3.push(`<!----><b class="svelte-18zyimi">`);
          text($$renderer3, {
            value: decision.name,
            label: "Decision",
            placeholder: "Rule",
